...
class SettingsTab(QWidget):
    ...
    def _build_protection_settings_box(self) -> QGroupBox:
        ...
        self._spin_be_trigger = self._make_spin(0.3, 5.0, 1.0, "R", spin_style, 100)
        s1_row.addWidget(self._spin_be_trigger)
        s1_row.addWidget(self._make_label(
            "  (1.0R = your initial risk amount)", C["label"],
        ))
        s1_row.addStretch()
        ...
        self._spin_lock_trigger = self._make_spin(0.5, 5.0, 1.5, "R", spin_style, 100)
        ...
        self._spin_lock_amount = self._make_spin(0.1, 3.0, 0.5, "R", spin_style, 100)
        s2_row2.addWidget(self._spin_lock_amount)
        s2_row2.addWidget(self._make_label(
            "  (e.g. 0.5R = half your original risk locked as profit)", C["label"],
        ))
        s2_row2.addStretch()
        ...
        self._spin_trail_trigger = self._make_spin(1.0, 10.0, 2.0, "R", spin_style, 100)
