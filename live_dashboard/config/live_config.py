...
_USER_SAVEABLE_FIELDS = {
    ...
    "protection_use_currency_thresholds",
    "protection_be_trigger_gbp",
    "protection_lock_trigger_gbp",
    "protection_lock_amount_gbp",
    "protection_trail_trigger_gbp",
    "manual_use_currency_thresholds",
    "manual_be_trigger_gbp",
    "manual_lock_trigger_gbp",
    "manual_lock_amount_gbp",
    "manual_trail_trigger_gbp",
}
...
class LiveConfig:
    ...
    # Currency (£) based thresholds -- replaces R-multiple thresholds in the UI
    # When protection_use_currency_thresholds=True, these override the _r fields above
    protection_use_currency_thresholds: bool = True
    protection_be_trigger_gbp: float = 2.00    # Stage 1: break even when P/L reaches +£2.00
    protection_lock_trigger_gbp: float = 3.00  # Stage 2: lock profit when P/L reaches +£3.00
    protection_lock_amount_gbp: float = 1.50   # Guaranteed profit = £1.50
    protection_trail_trigger_gbp: float = 4.00 # Stage 3: trailing stop when P/L reaches +£4.00
    ...
    manual_use_currency_thresholds: bool = True
    manual_be_trigger_gbp: float = 2.00
    manual_lock_trigger_gbp: float = 3.00
    manual_lock_amount_gbp: float = 1.50
    manual_trail_trigger_gbp: float = 4.00
